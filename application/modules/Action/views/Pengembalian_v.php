...
<body class="">
        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <form id="FormSearch1" page="/Action/Ajax_action/pengembalian_" class="form-inline pull-right" table="pengembalian" role="form">
                                    ...
                                    <form class="row" id=filter>
                                        ...
                                        <div class="form-group col-md-3" style="width: 100% ; margin-top: 0px">
                                            ...
                                            <select name="sort" id="sort"  style="width: 100%" class="form-control select2 dropdown-sort" required>
                                                ...
                                                <option value="tgl_peminjaman asc">Tgl Peminjaman (A-Z)</option>
                                                <option value="tgl_pengembalian asc">Tgl Pengembalian (A-Z)</option>
                                                <option value="tgl_pengembalian desc">Tgl Pengembalian (Z-A)</option>
    ...
    <script type="text/javascript">
        var page = "/Action/Ajax_action/pengembalian_";
