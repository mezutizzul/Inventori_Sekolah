...
<body class="">
        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <form id="FormSearch1" page="/Action/Ajax_action/barang_" class="form-inline pull-right" table="barang" role="form">
                            ...
                            <div class="card ">
                                ...
                                <div class="card-footer pull-right">
                                    <div class="pagination-setting-barang hidden" page="/Action/Ajax_action/barang_">
    ...
    <?php  $this->load->view('modal/Peminjaman_add'); ?>
