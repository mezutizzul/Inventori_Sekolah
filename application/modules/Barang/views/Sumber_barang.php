...
<body class="">
                        ...
                        <div class="col-md-12">
                            <div class="card ">
                                <div class="card-header">
                                    <form id="FormSearch" page="/Barang/Ajax_barang/sumber_" class="form-inline pull-right" table="sumberbarang" role="form">
                                        <div class="form-group ">
                                            <label for="jenis" class="bmd-label-floating">Cari Sumber Barang</label>
                                        ...
                                        <div class="form-group  pull-right">
                                            ...
                                            <a class="btn btn-primary btn-sm btn-fab btn-icons" data-toggle="modal" href='#sumber_add'>
                                ...
                                <div class="card-body table-responsive">
                                    <table class="table table-striped datatable-sumberbarang">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Sumber Barang</th>
                                ...
                                <div class="card-footer pull-right">
                                    <div class="pagination-setting-sumberbarang hidden" page="/Barang/Ajax_barang/sumber_">
    ...
    <!-- modal  -->
    <?php $this->load->view('modal/Sumber_add'); ?>
    <?php $this->load->view('modal/Sumber_edit'); ?>
    <?php $this->load->view('modal/Sumber_delete'); ?>
    ...
    <script type="text/javascript">
        var page = "/Barang/Ajax_barang/sumber_";
        $(document).ready(function() {
            GetData(request, "sumberbarang");
        });

        var FrmTambahKategori = $("#FormAddSumber").validate({
        ...
        var FrmDeleteKategori = $("#FormDeleteSumber").validate({
            submitHandler: function(form) {
        ...
        var FrmEditKategori = $("#FormEditSumber").validate({
            submitHandler: function(form) {
