...
<body class="">
                        ...
                        <div class="col-md-12">
                            <div class="card ">
                                <div class="card-header">
                                    <form id="FormSearch" page="/Barang/Ajax_barang/satuan_" class="form-inline pull-right" table="satuanbarang" role="form">
                                        <div class="form-group ">
                                            <label for="jenis" class="bmd-label-floating">Cari Satuan Barang</label>
                                        ...
                                        <div class="form-group  pull-right">
                                            <a class="btn btn-primary btn-sm btn-fab btn-icons" data-toggle="modal" href='#satuan_add'>
                                ...
                                <div class="card-body table-responsive">
                                    <table class="table table-striped datatable-satuanbarang">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Satuan Barang</th>
                                ...
                                <div class="card-footer pull-right">
                                    <div class="pagination-setting-satuanbarang hidden" page="/Barang/Ajax_barang/satuan_">
    ...
    <!-- modal  -->
    <?php $this->load->view('modal/Satuan_add'); ?>
    <?php $this->load->view('modal/Satuan_edit'); ?>
    <?php $this->load->view('modal/Satuan_delete'); ?>
    ...
    <script type="text/javascript">
        var page = "/Barang/Ajax_barang/satuan_";
        $(document).ready(function() {
            GetData(request, "satuanbarang");
        });

        var FrmTambahKategori = $("#FormAddSatuan").validate({
        ...
        var FrmDeleteKategori = $("#FormDeleteSatuan").validate({
            submitHandler: function(form) {
        ...
        var FrmEditKategori = $("#FormEditSatuan").validate({
            submitHandler: function(form) {
