		...
		if(!$Output['IsError']){
			...
			if(empty($Output['Data'])){
				...
				foreach ($Output['Data'] as $index => $value) {
					...
					<td>'.$value['stok_keluar'].'</td>
					<td class="text-center">'.$value['akhir'].'</td>
					<td class="text-center"><a class="btn btn-primary btn-sm btn-fab btn-icons" target="blank_" href="'.base_url("laporan/pdf_per_barang/").$value['id'].'.html"> <i class="fa fa-file-pdf-o"></i> </a></td>
