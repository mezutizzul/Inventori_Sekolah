...
class Laporan extends MY_Controller {
	...
	public function __construct(){   
		parent::__construct();
		$this->load->model('Barang/Barang' , 'Bar');
		$this->load->model('Stok/Stokmasuk' , 'sm');
		$this->load->model('Stok/Stokkeluar' , 'sk');
		$this->load->model('Action/Pinjam' , 'pj');
		$this->load->model('Action/Pelanggan' , 'pg');
	...
	public function print_barang_masuk(){
		...
		if(empty($list->result())){
			...
			$setting = $this->db->get('setting_pdf')->result()[0];	
			$this->load->view('Cetak/Barang_masuk_print',array("setting" => $setting , "kode" => $_GET['kode'] , "list" => $list->result() , "Stok"=> true , "Stok_barang" =>true , "page" => "Stok Barang"));
		}
	}
	...
	public function print_barang_keluar(){
		...
		if(empty($list->result())){
			...
			$setting = $this->db->get('setting_pdf')->result()[0];	
			$this->load->view('Cetak/Barang_keluar_print',array("setting" => $setting , "kode" => $_GET['kode'] , "list" => $list->result() , "Stok"=> true , "Stok_barang" =>true , "page" => "Stok Barang"));
		}
	}
	...
	public function laporan_masuk_perbarang(){
		...
		if(empty($list->result())){
			...
			$setting = $this->db->get('setting_pdf')->result()[0];	
			$this->load->view('Cetak/Laporan_masuk_B',array("setting" => $setting , "kode" => $_GET['kode'] , "list" => $list->result() , "Stok"=> true , "Stok_barang" =>true , "page" => "Stok Barang"));
		}
	}
