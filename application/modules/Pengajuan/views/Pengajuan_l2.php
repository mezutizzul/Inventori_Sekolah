...
<body class="">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form id="FormSearch1" page="/Pengajuan/Ajax_pengajuan/pengajuan_" class=" form-inline pull-right" table="pengajuan" role="form">
                                ...
                                <button type="submit" class="btn hidden btn-primary btn-sm btn-fab btn-icons"><i class="fa fa-search"></i></button>
    ...
    <div class="modal fade" id="pengajuan_add">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                ...
                <form action="" method="POST" role="form" id="FormAddPengajuan">                    
                    <div class="modal-body">    
                        <div class="form-group bmd-form-group">
                            <label for="addnama" class="bmd-label-floating">Nama Barang</label>
                            <input type="text" class="form-control" required id="addnama" name="barang">
                        </div>
                        <div class="form-group bmd-form-group">
                            <label for="spek" class="bmd-label-floating">Spesifikasi</label>
                            <input type="text" class="form-control" required id="spek" name="spesifikasi">
                        </div>
                        <div class="form-group bmd-form-group">
                            <label for="jml" class="bmd-label-floating">Jumlah</label>
                            <input type="text" class="form-control no" required id="jml" name="jumlah">
                        </div>
                        <div class="form-group" style="width: 100% ; margin-top: 0px">
                            <label for="id_satuan" class="control-label">Satuan Barang</label><br>
                            <select name="id_satuan" id="id_satuan"  style="width: 100%" class="form-control select2 dropdown-satuanbarang" required>
                        ...
                        <div class="form-group bmd-form-group">
                            <label for="hrg" class="bmd-label-floating">Harga Persatuan</label>
                            <input type="text" class="form-control no" required id="hrg" name="harga_satuan">
                        </div>
                        <div class="form-group bmd-form-group">
                            <label for="guna" class="bmd-label-floating">Kegunaan</label>
                            <input type="text" class="form-control" required id="guna" name="kegunaan">
                        </div>
                        <div class="form-group">
                            <label for="tgl" class="">Tanggal Pengajuan</label>
                            <input type="text" class="form-control datetimepicker" required id="tgl" name="tgl_pengajuan">
                        </div>
                        <div class="form-group bmd-form-group">
                            <label for="ket" class="bmd-label-floating">Keterangan</label>
                            <input type="text" class="form-control" id="guna" name="keterangan">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <a role="button" class="btn btn-danger text-white" data-dismiss="modal">Batal</a>
                ...
                GetDropdownKategori('','',function(resp){
                    GetDropdownSatuan('','',function(resp){
                        GetDropdownPelanggan('','',function(resp){
                            page = "/Pengajuan/Ajax_pengajuan/pengajuan1_";
