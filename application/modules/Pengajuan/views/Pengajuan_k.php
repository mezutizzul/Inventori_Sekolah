...
<body class="">
        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <form id="FormSearch1" page="/Pengajuan/Ajax_pengajuan/pengajuan4_" class="form-inline pull-right" table="pengajuan" role="form">
                                ...
                                <div class="form-group  pull-right">
                                    ...
                                    <a class="btn btn-primaru hidden btn-sm btn-fab btn-icons" data-toggle="modal" href='#pengajuan4_add'>
                            ...
                            <div class="card ">
                                    ...
                                    <table class="table table-striped datatable-pengajuan">
                                        <thead>
                                            <tr>
                                                ...
                                                <th  style="text-align: center;">Sarpras</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                ...
                                <div class="card-footer pull-right">
                                    <div class="pagination-setting-pengajuan hidden" page="/Pengajuan/Ajax_pengajuan/pengajuan4_">
                        ...
                        <div class="form-group" style="width: 100% ; margin-top: 0px">
                            <div class="form-group">
                                ...
                                <center>
                                    ...
                                    <input type="hidden" id="foto" name="upload_kaprok">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="" method="POST" role="form" id="EditStatus">                    
                    <div class="modal-body">    
                        <div class="form-group" style="width: 100% ; margin-top: 0px">
                            <label for="id_satuan" class="control-label">Status Barang</label><br>
                            <select name="status" id="id_satuan"  style="width: 100%" class="form-control select2 dropdown" required>
    ...
    <script type="text/javascript">
        var page = "/Pengajuan/Ajax_pengajuan/pengajuan4_";
            ...
            GetDropdownKategori('','',function(resp){
                GetDropdownSatuan('','',function(resp){
                    GetDropdownJurusan('','',function(resp){
                        page = "/Pengajuan/Ajax_pengajuan/pengajuan4_";
