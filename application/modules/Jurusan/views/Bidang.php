...
<body class="">
        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <form id="FormSearch1" page="/Jurusan/Ajax_jurusan/bidang_" class="form-inline pull-right" table="jurusan" role="form">
                            ...
                            <div class="card ">
                                ...
                                <div class="card-footer pull-right">
                                    <div class="pagination-setting-jurusan hidden" page="/Jurusan/Ajax_jurusan/bidang_">
    ...
    <div class="modal fade" id="jurusan_add">
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">Bidang Keahlian</h4>
            </div>
            <form action="" method="POST" role="form" id="FormAddJurusan">                    
                <div class="modal-body">    
                    <div class="form-group bmd-form-group">
                        <label for="addnama" class="bmd-label-floating">Bidang Keahlian</label>
    ...
    <div class="modal fade" id="jurusan_delete">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title">Hapus Bidang Keahlian</h4>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="" class="form-edit hidden" method="POST" role="form" id="FormEditJurusan">
                    <div class="modal-body">
                        <div class="form-group bmd-form-group">
                            <label for="jenis_barang" class="label">Bidang Keahlian</label>
    ...
    <script type="text/javascript">
        var page = "/Jurusan/Ajax_jurusan/bidang_";
        ...
        var FrmTambahKategori = $("#FormAddJurusan").validate({
            submitHandler: function(form) {
                InsertData(form, function(resp) {
                    page = "/Jurusan/Ajax_jurusan/bidang_";
                    GetData(request, "jurusan");
                });
            },
