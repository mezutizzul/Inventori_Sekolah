                        ...
                        <div class="col-md-12">
                            <form id="FormSearch1" page="/Barang/Ajax_barang/stok_barang_" class="form-inline pull-right" table="barang" role="form">
                                ...
                                <div class="form-group  pull-right">
                                    ...
                                    <a class="btn btn-primary btn-sm btn-fab btn-icons cetak_periode">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#FormSearch1").submit(function() {
                ...
                page = $(this).attr("page");
                GetData(request, table,function(resp){
                    page = "/Stok/Ajax_stok/keluar_";
                    GetData(request, "keluar",function(resp){
        ...
        $(".cetak_periode").click(function(event) {
            var tgl_awal = $("#filter .tgl_awal").val();
            var tgl_akhir = $("#filter .tgl_akhir").val();
            if(empty(tgl_awal)|| empty(tgl_akhir)){
                setTimeout(function(){
                ...
                window.open(base_url+"Laporan/pdf_periode.html?awal="+tgl_awal+"&akhir="+tgl_akhir , "","");
            }
        });
