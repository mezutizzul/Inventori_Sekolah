				...
				<td width="50%">
					<table width="100%" style="">
						<tr>
							...
							<td width="75%">'.$det->unit_kerja.'</td>
						</tr>
						<tr>
							<td width="20%">Keterangan</td>
							<td width="5%" align="center">:</td>
							<td width="75%">'.$det->keterangan.'</td>
						</tr>
					</table>
				</td>
				<td width="50%" >
					<table width="100%" style="float:right">
						<tr>
							...
							<td width="5%">:</td>
							<td width="55%">'.date("d/m/Y H:i:s",strtotime($det->tgl_keluar)).'</td>
						</tr>
						<tr>
							<td></td>
							<td>Nomor</td>
