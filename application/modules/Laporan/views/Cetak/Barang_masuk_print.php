<?php   		
			...
			<tr>
				<td width="50%">
					<table width="100%" style="">
						<tr>
							<td width="20%">Suplier</td>
							<td width="5%" align="center">:</td>
							<td width="75%"><b>'.$list[0]->supplier.'</b></td>
						</tr>
						<tr>
							<td width="20%"></td>
							<td width="5%" align="center"></td>
				...
				<td width="50%" >
					<table width="100%" style="float:right">
						<tr>
							...
							<td width="5%">:</td>
							<td width="55%">'.date("d/m/Y H:i:s" , strtotime($list[0]->tgl_masuk)).'</td>
						</tr>
						<tr>
							<td></td>
							<td>Nomor</td>
	...
	foreach ($list as $key => $val) {
		$txt.= '<tr>
					...
					<td width="55%" style="border-top: 1px dashed #ddd; border-bottom:none;border-right:1px solid black">
						<b>'.$val->nama.'</b>
					</td>
					<td width="15%" style="border-top: 1px dashed #ddd; border-bottom:none;border-right:1px solid black">
						<b>'.$val->jml.'</b>
	...
	$txt .=	'
		...
		<table  border="1" style="font-size:14px" align="center" rules="rows">
			<tr>
				...
				<td width="40%" align="center" style="border:1px black solid">
					<table>
						<tr>
							<td> </td>
						</tr>
