...
<body class="">
        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <form id="FormSearch1" page="/Stok/Ajax_stok/masuk_" class="form-inline pull-right" table="masuk" role="form">
                            ...
                            <div class="card ">
                                ...
                                <div class="card-footer pull-right">
                                    <div class="pagination-setting-masuk hidden" page="/Stok/Ajax_stok/masuk_">
    ...
    <?php $this->load->view('modal/Masuk_add'); ?>
    <?php $this->load->view('modal/Masuk_edit'); ?>
    <?php $this->load->view('modal/Masuk_delete'); ?>
    ...
    <script type="text/javascript">
        var page = "/Stok/Ajax_stok/masuk_";
